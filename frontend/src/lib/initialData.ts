...
export const INITIAL_BANKS: Bank[] = [
  ...
  { id: 'bank-agr',     org_id: DEFAULT_ORG_ID, name: 'Agribank',            code: 'AGR',     is_mb: false, active: true, display_order: 4 },
  { id: 'bank-tcb',     org_id: DEFAULT_ORG_ID, name: 'Techcombank Business', code: 'TCB',    is_mb: false, active: true, display_order: 5 },
  { id: 'bank-acb',     org_id: DEFAULT_ORG_ID, name: 'ACB',                 code: 'ACB',     is_mb: false, active: true, display_order: 6 },
  { id: 'bank-vpb',     org_id: DEFAULT_ORG_ID, name: 'VPBank NEOBiz',       code: 'VPB',     is_mb: false, active: true, display_order: 7 },
  { id: 'bank-shb',     org_id: DEFAULT_ORG_ID, name: 'SHB',                 code: 'SHB',     is_mb: false, active: true, display_order: 8 },
  { id: 'bank-stb',     org_id: DEFAULT_ORG_ID, name: 'Sacombank',           code: 'STB',     is_mb: false, active: true, display_order: 9 },
];
...
export const INITIAL_SOURCE_PAIRS: SourcePair[] = [
  // 1. MB Bank — Doanh nghiệp
  {
    ...
    website_url: 'https://business.mbbank.com.vn',
  ...
  // 4. VietinBank — Doanh nghiệp (eFAST)
  {
    ...
    website_url: 'https://www.vietinbank.vn/web/home/vn/product/corporate',
    facebook_verified: true,
    website_verified: true,
    display_order: 3,
  },
  // 5. Agribank — Doanh nghiệp
  {
    id: 'pair-5',
    org_id: DEFAULT_ORG_ID,
    bank_id: 'bank-agr',
